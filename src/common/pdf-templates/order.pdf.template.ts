      ...
      <tbody>
        <tr>
          ...
          <td class="w-1/2 align-top text-right">
            <div class="text-sm text-neutral-600">
              <p class="font-bold" style="text-transform: capitalize !important">${order.customer.name}</p>
    ...
    <table class="w-full border-collapse border-spacing-0">
      ...
      ${order.productToOrder?.map(
        ...
        <tr>
          ...
          <td class="border-b py-3 pl-2 text-right">${fCurrency(product.snapshotProductPrice || product.product.price, order.application.currencySymbol)}</td>
          <td class="border-b py-3 pl-2 text-center">${product?.quantity}</td>
          <td class="border-b py-3 pl-2 text-center">${fCurrency(product.snapshotProductPrice * product.quantity, order.application.currencySymbol)}</td>
        </tr>`,
      )}
        <tr>
          <td colspan="7">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="border-b p-3 text-right">
                            <div class="whitespace-nowrap font-bold text-main">${fCurrency(order?.totalOrderAmount, order.application.currencySymbol)}</div>
                          </td>
                        </tr>
                        <tr>
                          <td class="p-3">
                          ...
                          <td class="p-3 text-right">
                            <div class="whitespace-nowrap font-bold text-main">${order?.discount}%</div>
                          </td>
                        </tr>
                        <tr>
                          <td class="p-3">
                            <div class="whitespace-nowrap text-slate-400">Tax (${order?.snapshotTaxPercentage || '0'}%):</div>
                          </td>
                          <td class="p-3 text-right">
